   ...
   ?>
    ...
    <div class="container">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/barang/tambah_barang'?>">
                <div class="modal-body">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="keterangan" class="form-control" type="text" placeholder="Keterangan..." style="width:335px;">
                        </div>
                    </div>
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/barang/edit_barang'?>">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label class="control-label col-xs-3" >Keterangan</label>
                            <div class="col-xs-9">
                                <input name="keterangan" class="keterangan form-control" type="text" value="<?php echo $keterangan;?>" placeholder="Keterangan..." style="width:335px;" required>
                            </div>
                        </div>
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p style="text-align:center;">Copyright &copy; <?php echo '2019';?> by Mirza Mahendra</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
